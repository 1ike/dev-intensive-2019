...
//    и абстрактный метод formatMessage() - возвращает строку содержащюю информацию
//    о id сообщения, имени получателя/отправителя, виде сообщения ("получил/отправил")
//    и типе сообщения ("сообщение"/"изображение")
//
//    Реализуй паттерн AbstractFactory с методом
//    makeMessage(from, chat, date, type, payload, isIncoming = false) принимающий в качесте
//    аргументов пользователя создавшего сообщение, чат к которому относится сообщение,
...
//    BaseMessage.makeMessage(user, chat, date, "https://anyurl.com", "image",true)
